...
{
  private float sensorLower = 0; //センサー値下限
  private float sensorHigher = 300; //センサー値上限
  private float sensorConfirmLower = 100; //センサー評価値下限
  private float sensorConfirmHigher = 150; //センサー評価値上限
  ...
  public void tick()
  {
    ...
    println(_moduleContainer.DistanceValue);
